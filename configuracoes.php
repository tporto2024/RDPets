...
function setAba(aba) {
    document.getElementById('painel-tipos').classList.toggle('hidden', aba !== 'tipos');
    document.getElementById('painel-etapas').classList.toggle('hidden', aba !== 'etapas');
    document.querySelectorAll('.tab-btn').forEach(b => {
        b.classList.toggle('bg-white', false);
        b.classList.toggle('shadow-sm', false);
        b.classList.toggle('text-gray-800', false);
        b.classList.toggle('text-gray-500', false);
    });
    const active = document.getElementById('tab-' + aba);
    active.classList.add('bg-white', 'shadow-sm', 'text-gray-800');
    document.querySelectorAll('.tab-btn:not(#tab-' + aba + ')').forEach(b => b.classList.add('text-gray-500'));
